...
def check_artemis_rest_api(host, port, username, password, queue_name):
    ...
    try:
        ...
        print(f"🌐 Checking Artemis REST API...")
        ...
        if response.status_code == 200:
            ...
            if data.get('status') == 200:
                ...
                print(f"✅ Queue information retrieved successfully:")
                ...
                print(f"   • Messages acknowledged: {queue_info.get('MessagesAcknowledged', 'N/A')}")
...
Examples:
  ...
  python tools/check_artemis_console.py --host localhost --port 8161
    ...
    parser.add_argument(
        '--host',
        default='localhost',
        help='Artemis host (default: localhost)'
    )
    ...
    try:
        ...
        try:
            ...
            if 'amqp' in config_data:
                ...
                print(f"⚠️  No AMQP config found, using defaults")
        ...
        print(f"   • AMQP Port: 61616 (assumed)")
        ...
        print(f"   4. Check the 'Message Count' to see queued messages")
        print(f"   5. Click on the queue name to see message details")
        ...
        if not args.no_api_check:
            ...
            if HAS_REQUESTS:
                ...
                if not success:
                    ...
                    print(f"   • Make sure Artemis is running")
                ...
                print(f"⚠️  'requests' library not available, skipping REST API check")
        ...
        print(f"   • Use message verification tool:")
        print(f"     python tools/verify_queue_messages.py --max-messages 5")
        print(f"   • Use round-trip test:")
        print(f"     python tools/test_queue_roundtrip.py")
        print(f"   • Check Artemis logs for connection/message activity")
